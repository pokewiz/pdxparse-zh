...
ppHandlers = Tr.fromList
        ...
        ,("num_of_subjects"                  , numeric MsgNumOfSubjects)
        ,("tech_difference"                  , numeric MsgTechDifference)
        ,("ruler_age"                        , numeric MsgRulerAge)
        ,("num_of_aspects"                   , numeric MsgNumOfAspects)
        ,("colony"                           , numeric MsgColony)
        ,("province_trade_power"             , numeric MsgProvinceTradePower)
        ,("convert_female_heir_to_general"   , numeric MsgConvertFemaleHeirToGeneral)
        -- Numbers
